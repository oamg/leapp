...
help:
	...
	@echo "                         - available containers are:" el{8..9} f{35..42} rawhide
...
clean_containers:
	@for i in leapp-build-el{8,9} leapp-build-f{35..42} leapp-build-rawhide leapp-tests-rhel{8..10}; do \
